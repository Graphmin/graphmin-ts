...
/**
 * A string parser class that can be used to parse a string and emit events based on certain conditions.
 *
 * @class StringParser
 */
class StringParser {
	...
	/**
	 * Handles nested structures in the input string, and emits events when nested structures are encountered.
	 *
	 * @memberof StringParser
	 */
	handleNesting() {
	...
	/**
	 * Handles different types of numbers in the input string, and emits events when numbers are encountered.
	 *
	 * @memberof StringParser
	 */
	handleNumbers() {
	...
	/**
	 * Handles escape sequences in the input string, and emits events when escape sequences are encountered.
	 *
	 * @memberof StringParser
	 */
	...
	/**
	 * Handles comments in the input string, and emits events when comments are encountered.
	 *
	 * @memberof StringParser
	 */
	handleComments() {
